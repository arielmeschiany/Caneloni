...
export function LocationDetail({ location, onClose, onAuthRequired }: LocationDetailProps) {
    ...
    <div className="fixed inset-0 z-40 flex items-end sm:items-center justify-center bg-brown/40 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="flex items-start justify-between p-5 pb-3">
          ...
          <button
            onClick={onClose}
            className="text-brown/40 hover:text-brown text-2xl leading-none transition-colors shrink-0"
          >
            ×
          </button>
        </div>
